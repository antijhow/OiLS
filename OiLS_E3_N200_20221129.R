...
plot(x, y, lty=1, col = "grey",type="l",main="N=200",xlim=c(0,1),ylim=c(-10,10),xlab="",ylab="",cex.main = 3,cex.axis=1.5)              # Create first plot
...
legend(x=0.22,y=0.78, c(expression(y),expression("dist"*(hat(alpha)[])),expression("dist"*(hat(a)["2,2"]))),lty=c(1,2,5),col=c("grey","red","blue"),cex=1.5,lwd=4 )
